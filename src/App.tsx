...
import {
  ...
  Calendar, ChevronLeft, FileCheck, Megaphone, Server,
} from 'lucide-react';
import {
    ...
    <div className="flex h-screen bg-[#F8FAFC] text-[#1E293B] font-['Inter',sans-serif]">
      ...
      <aside className="w-72 bg-[#0F172A] text-white flex flex-col shadow-2xl z-20">
        ...
        <nav className="flex-1 px-4 space-y-1.5 mt-6">
          ...
          <a
            href="/workers"
            className="w-full flex items-center gap-3 px-5 py-3.5 rounded-2xl font-semibold transition-all text-gray-400 hover:bg-cyan-500/10 hover:text-cyan-300"
          >
            <Server className="w-5 h-5" /> Воркеры
          </a>
        </nav>
